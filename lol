...
/* Función callback para manejar las interrupciones de los botones */
...
int main(void)
{
  ...
  while (1)
  {
    ...
    if (btnPressed) {
        ...
        // Leer el valor del potenciómetro correspondiente a través de UART
        HAL_UART_Receive(&huart1, uartRxBuffer, sizeof(uartRxBuffer), HAL_MAX_DELAY);

        // Actualizar contador según el botón presionado
        if (btnPressed == 1) {
            contador = uartRxBuffer[0]; // Asignar el valor recibido a contador
        } else {
            contador2 = uartRxBuffer[0]; // Asignar el valor recibido a contador2
        }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, D1_Pin|D2_Pin|E_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : D1_Pin D2_Pin E_Pin */
  GPIO_InitStruct.Pin = D1_Pin|D2_Pin|E_Pin;
...
void mostrador(){
	//Mostrar en display medición de potenciometro 1
	   ...
	   HAL_GPIO_WritePin(D1_GPIO_Port,D1_Pin, GPIO_PIN_RESET);
	    ...
	    //Mostrar en display medición de potenciómetro 2
